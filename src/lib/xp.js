...
export const TITLES = [
    { name: 'Thái Thượng Vong Tình Quyết', lv: 200 },
    { name: 'Thiên cơ bất khả lộ', lv: 190 },
    { name: 'Đệ nhất kiếm tiên', lv: 180 },
    { name: 'Bóng Đêm Vô Tận', lv: 170 },
    { name: 'Vạn cổ như đêm dài', lv: 160 },
    { name: 'Thâm tàng bất lộ', lv: 150 },
    { name: 'Sát Thủ Bóng Đêm', lv: 140 },
    { name: 'Độc cô cầu bại', lv: 130 },
    { name: 'Đệ nhị thiên hạ', lv: 120 },
    { name: 'Thịnh cực tất suy', lv: 115 },
    { name: 'Tuệ cực tất thương', lv: 110 },
    { name: 'Ẩn sĩ sơn lâm', lv: 105 },
    { name: 'Tàn ảnh phong vân', lv: 100 },
    { name: 'Túy quyền tửu khách', lv: 95 },
    { name: 'Hành giả độc hành', lv: 90 },
    { name: 'Lối đi riêng', lv: 85 },
    { name: 'Cửu sư thúc', lv: 80 },
    { name: 'Cao nhân ở ẩn', lv: 75 },
    { name: 'Đại tiểu thư', lv: 70 },
    { name: 'Băng thanh ngọc khiết', lv: 68 },
    { name: 'Ôn nhuận như ngọc', lv: 65 },
    { name: 'Lãng khách', lv: 62 },
    { name: 'Đại sư tỷ', lv: 60 },
    { name: 'Đại sư huynh', lv: 58 },
    { name: 'Tiểu sư muội', lv: 55 },
    { name: 'Kỳ môn độn giả', lv: 52 },
    { name: 'Tiểu vọng thư', lv: 50 },
    { name: 'Họa mây', lv: 48 },
    { name: 'Tàng thư các chủ', lv: 45 },
    { name: 'Sĩ phu', lv: 42 },
    { name: 'Nho sinh', lv: 40 },
    { name: 'Vạn kiếp bất phục', lv: 38 },
    { name: 'Nhân sinh như mộng', lv: 35 },
    { name: 'Dục tốc bất đạt', lv: 32 },
    { name: 'Hồ ly tinh', lv: 30 },
    { name: 'Giang hồ tiểu bạch', lv: 25 },
    { name: 'Vật có duyên với ta', lv: 22 },
    { name: 'Đạo hữu dừng bước', lv: 20 },
    { name: 'Hàn môn tử đệ', lv: 18 },
    { name: 'Tẩu vi thượng sách', lv: 15 },
    { name: 'Nhất kiến chung tình', lv: 12 },
