...
- [x] **Admin Image Preview Fix & Migration**: Sửa lỗi ảnh broken trong Admin. Đã triển khai **Smart R2 Recovery (v3)**: Tự động phát hiện và sửa các URL lỗi/cũ mà không làm ảnh hưởng đến các URL mới đã đúng, hỗ trợ đa môi trường (Local/Vercel). 🖼️🚀🛡️
...
- [x] **Smart R2 Recovery (v3)**: Cơ chế thông minh bảo vệ các URL đã đúng và chỉ sửa các URL bị hỏng. 🧠✨
...
*Cập nhật lần cuối: 21:40 - 11/04/2026*
