...
- [x] **Admin Image Preview Fix**: Sửa lỗi ảnh bị hỏng (Broken Images) trong trang Chỉnh sửa chương. Đã xử lý các trường hợp URL bị thiếu prefix, lỗi `undefined/` và thêm fallback tự động quay về ảnh gốc nếu Cloudinary gặp sự cố. 🖼️🛡️
...
*Cập nhật lần cuối: 21:23 - 11/04/2026*
