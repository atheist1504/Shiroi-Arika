...
- [x] **Admin Image Preview Fix & Migration**: Sửa lỗi ảnh broken trong Admin. Đã thêm logic **Hành trình URL (Super Fix)**: Tự động chuyển đổi các Domain R2 cũ/lỗi sang Domain R2 mới nhất trong cấu hình, giúp hiển thị lại toàn bộ ảnh cũ mà không cần chỉnh sửa DB thủ công. 🖼️🚀🛡️
...
*Cập nhật lần cuối: 21:28 - 11/04/2026*
