...
- [x] **Direct-to-R2 Ultra Upload (v2.5)**: Chuyển đổi sang kiến trúc Signed URLs, cho phép upload trực tiếp từ Client lên R2. Vượt qua giới hạn 4.5MB của Vercel, hỗ trợ tải ảnh song song siêu tốc và nén ảnh thích ứng (Adaptive Quality). 🚀⚡
